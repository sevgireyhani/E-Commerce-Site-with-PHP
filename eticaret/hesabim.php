...
<div class="container">
	...
	<form action="radmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="title-bg">
					<div class="title">Şifrenizi mi Unuttunuz? Şifre Güncelleme İşlemleri İçin Logoya Tıklayınız.</div>
				</div>

					<hr>
					
					<center><a href="sifre-guncelle"><img width="100" src="<?php echo $ayarcek['ayar_logo'] ?>" alt="Site Logosu" class="logo img-responsive"></a></center>
