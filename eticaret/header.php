...
ob_start();
session_start();
include 'radmin/netting/baglan.php';
include 'radmin/production/fonksiyon.php';
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-md-4 main-logo">
					<a href="index.php"><img width="125" height="150" src="<?php echo $ayarcek['ayar_logo'] ?>" alt="Site Logosu" class="logo img-responsive"></a>
				</div>
								...
								<div class="row">
									<div class="col-md-6 regform">
										<div class="title-widget-bg">
										 ...
										 <form action="radmin/netting/islem.php" method="POST" role="form">
                 ...
                 <div class="form-group">
                   <button type="submit" name="kullanicigiris" class="btn btn-default btn-red btn-sm">Giriş Yap</button>
									...
									<div class="col-md-6">
										...
										<p>
											Buralarda yeni misin? Hadi bize katıl ve alışverişe başlamak için kayıt ol!
										</p>
	...
	<div class="main-nav"><!--end main-nav -->
		<div class="navbar navbar-default navbar-static-top">
			<div class="container">
				...
				<?php 
//// menucek menu_url alanı boş değilse menu_url alanını getir anlamındaki kod satırları.
///menu_url'yi hakkimizda sayfasına bağladığımız için buradaki uzantıyı menu_url'ye bağladığımızda da direkt olarak hakkımızda sayfasına aktarılıyoruz.
				...
				while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
					...
					?>
							...
							<div class="btn-popcart">
								<a href="sepet.php" class="btn btn-default btn-red btn-sm">Sepetime Git </a>
...
<ul class="small-menu">
  ...
  <li><a href="logout" class="mycheck">Çıkış Yap</a></li>
</ul>
