            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <script type="text/javascript">
...

               {
                ...
                filebrowserBrowselink : 'ckfinder/ckfinder.html',

                filebrowserImageBrowselink : 'ckfinder/ckfinder.html?type=Images',

                filebrowserFlashBrowselink : 'ckfinder/ckfinder.html?type=Flash',

                filebrowserUploadlink : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',

                filebrowserImageUploadlink : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',

                filebrowserFlashUploadlink : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',
