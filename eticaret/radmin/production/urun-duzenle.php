...
?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="../netting/islem.php " method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <!-- Kategori seçebilmemiz için dinamik bir yapı oluşturduk ve bunu admin paneline ekledik -->
  ...
  <!-- Eğer ürünün videosu varsa ya da kullanmak istersek diye bir ürün video alanı yaratıyoruz -->
