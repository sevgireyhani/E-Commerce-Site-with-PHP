...
//// Kullanıcı girişi yapmadan sayfaya girişi engellemiş olduk.///
if ($say==0) {
...
<head>
  ...
  <title>Entel Dantel E-Ticaret Sitesi</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-book"></i> <span>Entel Dantel!</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="hakkimizda.php"><i <i class="fa fa-question-circle"></i>></i> Hakkımızda </a></li>
                <li><a href="kullanici.php"><i class="fa fa-users"></i> Kullanıcılar </a></li>
                 ...
                 <li><a href="urun.php"><i class="fa fa-shopping-basket"></i> Ürünler </a></li>
                   <li><a href="kategori.php"><i class="fa fa-adjust"></i> Kategoriler </a></li>
                 ...
                 <li> <a href="banka.php"> <i class = "fa fa-bank"> </i> Bankalar </a> </li>
                  ...
                  <li><a><i class="fa fa-cogs"></i> Site Ayarları <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="genel-ayar.php"></i>Genel Ayarlar</a></li>
                      <li><a href="iletisim-ayar.php"></i>İletişim Ayarları</a></li>
                      <li><a href="api-ayar.php"></i>Api Ayarlar</a></li>
                      <li><a href="sosyal-ayar.php"></i>Sosyal Ayarlar</a></li>
                      <li><a href="mail-ayar.php"></i>Mail Ayarlar</a></li>
