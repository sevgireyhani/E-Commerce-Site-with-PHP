                    ...
                    <form action="../netting/islem.php " method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="ayar_smpthost" value="<?php echo $ayarcek['ayar_smpthost'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="ayar_smptpuser" value="<?php echo $ayarcek['ayar_smptpuser'] ?>"required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
