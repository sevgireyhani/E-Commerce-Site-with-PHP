...
///Yine Türkçe karakterler için fonksiyon dosyamızı işlemlerimizin gerçekleştiği bu işlem dosyamıza kaydettik.
...
if (isset($_POST['hesabimduzenle'])) {
	...
	if ($update) {
		...
		Header("Location:../production/hesabim.php?kullanici_id=$kullanici_id&durum=ok");

	} else {

		Header("Location:../production/hesabim.php?kullanici_id=$kullanici_id&durum=no");
	}
...
if (isset($_POST['kullanicikaydet'])) {
	...
	/// kullanıcının girdiği iki şifrenin doğru olup olmadığını kontrol ediyoruz. ///
...
// Başlangıç
			...
			if ($say==0) {
				...
				//md5 fonksiyonu ile şifreyi md5 şifreli hale getiriyoruz.
...
if (isset($_POST['sliderkaydet'])) {
	...
	//her bir resmin isminin birbirinden farklımolabilmesi ve ayırt edilebilmesi için bu yöntemi uyguluyoruz.
...
$ayarkaydet=$db->prepare("UPDATE ayar SET
	...
	ayar_smpthost=:ayar_ayar_smpthost,
	ayar_smptpuser=:ayar_smptpuser,
	ayar_smtppassword=:ayar_smtppassword,
	ayar_smtpport=:ayar_smtpport
	WHERE ayar_id=0");

$update=$ayarkaydet->execute(array(
	'ayar_smpthost' => $_POST['ayar_smpthost'],
	'ayar_smptpuser' => $_POST['ayar_smptpuser'],
